...
urlpatterns = [
    ...
    path("compras/new/", views.purchase_invoice_new_view, name="purchase_invoice_new"),
    ...
    path("compras/<int:pk>/anular/", views.void_purchase_invoice, name="void_purchase_invoice"),
    path("compras/<int:pk>/reactivar/", views.reactivate_purchase_invoice, name="reactivate_purchase_invoice"),
    path("ventas/new/", views.sale_invoice_new_view, name="sale_invoice_new"),
    ...
    path("ventas/<int:pk>/anular/", views.void_sale_invoice, name="void_sale_invoice"),
    path("ventas/<int:pk>/reactivar/", views.reactivate_sale_invoice, name="reactivate_sale_invoice"),
